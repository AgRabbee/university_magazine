                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Create Faculty</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="data-table-area mg-b-15">
                            <div class="container">
								<?php if(isset($_GET['errorfacName'])){?>
									<div class="alert alert-danger" role="alert">
									  Faculty name already exists!! Create a new one.
									</div>
								<?php }?>
								...
								<div class="row col-md-8">
									...
									<table class="table">
										<tr> 
											<td>Faculty Name</td>
											<td><input type="text" value="" class="form-control" required name="facName"/></td>
										</tr>
										<tr> 
											...
											<td>
												<select name="coordinator_user_id" class="form-control" required>
													...
													<?php 
														$sql = "SELECT * FROM `users` WHERE `userRole` = 3";
										...
										<tr> 
											<td></td>
											<td id="selection" ><input type="submit" class="btn btn-primary btn-sm" value="Create Faculty" name="new_fac_data"/></td>
										</tr>
									</table>
									</form>
								</div>
