                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                       <div class="charts-single-pro responsive-mg-b-30">
                            <div id="chart_contributor" style = "width: 550px; height: 400px; margin: 0 auto"></div>
							<?php 
							// php code for getting value from database
								$sql ="SELECT IFNULL(a.student_id, 0)as contributor, f.fac_name FROM faculties as f LEFT JOIN student as s ON f.fac_id = s.faculty_id LEFT JOIN articles as a ON a.student_id = s.id GROUP BY f.fac_name";
								
								$results = $connect->query($sql);
								$data ='';
								foreach($results as $val){
									$data .= '["'.$val['fac_name'].'",'.$val['contributor'].'],';
									}
							...
							<script type="text/javascript">
								...
								function drawStuff() {
									...
									var chart = new google.charts.Bar(document.getElementById('chart_contributor'));
